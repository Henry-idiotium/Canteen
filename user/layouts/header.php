                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        <div class="container p-1">
                            ...
                            <!-- Logo -->
                            <a class="sidebar-brand d-flex align-items-center justify-content-center ml-2" href="index.html">
                            ...
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item no-arrow mx-1">
                                    <a class="nav-link" href="cart.php?account=<?php echo $account; ?>" id="alertsDropdown" role="link">
                                ...
                                <li class="nav-item dropdown no-arrow">
                                    ...
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_GET['account']; ?></span>
